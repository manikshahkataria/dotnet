...
namespace gitEx2.Controllers
{
    public class PaysController : Controller
    {
        private readonly PayScaleContext _context;

        public PaysController(PayScaleContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PayBand,BasicSal")] Pay pay)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("PayBand,BasicSal")] Pay pay)
        {
            if (id != pay.PayBand)
            {
                return NotFound();
